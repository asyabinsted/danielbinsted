...
export default function WorkVideoPlayer({
  ...
  useEffect(() => {
    ...
    const handleCanPlay = () => {
      ...
      video.play().then(() => {
        ...
        // If autoplay fails, still hide poster after a delay
        setTimeout(() => setShowPoster(false), 1000);
      });
    };
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-[92vh] md:min-h-screen flex flex-col justify-end pb-1 md:pb-5 pointer-events-none">
