...
export const works: Record<string, WorkData> = {
  ...
  'riverside-magic-clips': {
    ...
    posterSrc: '/images/works/riverside-magic-clips/magic-clips-placeholder.jpg',
    credits: [
  ...
  'riverside-ai-transcriptions': {
    ...
    posterSrc: '/images/works/riverside-ai-transcriptions/ai-transcriptions-placeholder.jpg',
    credits: [
  ...
  'riverside-paid-social-01': {
    ...
    posterSrc: '/images/works/riverside-paid-social-01/riverside-01-placeholder.jpg',
    credits: [
  ...
  'riverside-paid-social-02': {
    ...
    posterSrc: '/images/works/riverside-paid-social-02/riverside-02-placeholder.jpg',
    credits: [
      'Director & Editor: Daniel Binsted',
    ],
    location: 'Riverside, a platform for recording podcasts and video interviews, facilitates remote recording with studio-quality results.',
  ...
  'echelonn-ai': {
    ...
    posterSrc: '/images/works/echelonn-ai/echelon-ai-placeholder.jpg',
    credits: [
      'Director & Editor: Daniel Binsted',
    ],
